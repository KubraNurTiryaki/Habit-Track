...
import com.knt.waterreminder.data.AlarmReminderProvider;

public class AlarmScheduler {

    /*schedule reminder alarm at the specified time for the given task
     *
     * @param context Local appication or actribvity context
     *
